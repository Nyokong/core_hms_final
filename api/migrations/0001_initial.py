    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='video_being_submitted', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Grade',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=255, verbose_name='title')),
                ('description', models.TextField(blank=True, null=True, verbose_name='description')),
                ('cmp_video', models.FileField(blank=True, null=True, upload_to='compressed_videos/', verbose_name='cmp_video')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
